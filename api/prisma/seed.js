...
const DEMO_USERNAMES = [
  ...
  "demo_student_malsha",
  "demo_student_tharushi",
  "demo_student_nethmi",
  "demo_student_rashmi",
  "demo_student_shenali",
  "demo_student_isuri",
  "demo_student_methmi",
  "demo_student_dinuka",
  "demo_owner_kandy",
...
async function main() {
  ...
  const roommateStudents = await Promise.all([
    ...
    prisma.user.create({
      data: {
        username: "demo_student_malsha",
        email: "malsha.demo@boardingfinder.test",
        password: passwordHash,
        fullName: "Malsha Wickramasinghe",
        phone: "0777890123",
        gender: "female",
        role: "student",
        isVerified: true,
        roommatePreference: {
          create: {
            ...
            foodPreference: "Vegetarian-friendly",
            sociabilityLevel: 3,
            notes: "Very close to the main demo profile and ideal for strong-match demos.",
          },
        },
      },
    }),
    prisma.user.create({
      data: {
        username: "demo_student_tharushi",
        email: "tharushi.demo@boardingfinder.test",
        password: passwordHash,
        fullName: "Tharushi Bandara",
        phone: "0778901234",
        gender: "female",
        role: "student",
        isVerified: true,
        roommatePreference: {
          create: {
            ...
            foodPreference: "Vegetarian-friendly",
            sociabilityLevel: 2,
            notes: "A tidy early riser with a strong academic routine.",
          },
        },
      },
    }),
    prisma.user.create({
      data: {
        username: "demo_student_nethmi",
        email: "nethmi.demo@boardingfinder.test",
        password: passwordHash,
        ...
        roommatePreference: {
          create: {
            ...
            sociabilityLevel: 4,
            notes: "Good medium-strength match with slightly different location and routine.",
          },
        },
      },
    }),
    prisma.user.create({
      data: {
        username: "demo_student_rashmi",
        email: "rashmi.demo@boardingfinder.test",
        password: passwordHash,
        fullName: "Rashmi Alwis",
        phone: "0780123456",
        gender: "female",
        role: "student",
        isVerified: true,
        roommatePreference: {
          create: {
            ...
            foodPreference: "Flexible",
            sociabilityLevel: 5,
            notes: "Useful for showing lower-ranked out-of-area matches.",
          },
        },
      },
    }),
    prisma.user.create({
      data: {
        username: "demo_student_shenali",
        email: "shenali.demo@boardingfinder.test",
        password: passwordHash,
        fullName: "Shenali Weerasekara",
        phone: "0781234567",
        gender: "female",
        role: "student",
        isVerified: true,
        roommatePreference: {
          create: {
            ...
            foodPreference: "Vegetarian-friendly",
            sociabilityLevel: 3,
            notes: "Another high-compatibility profile for a dense top of the list.",
          },
        },
      },
    }),
    prisma.user.create({
      data: {
        username: "demo_student_isuri",
        email: "isuri.demo@boardingfinder.test",
        password: passwordHash,
        fullName: "Isuri Rathnayake",
        phone: "0782345678",
        gender: "female",
        role: "student",
        isVerified: true,
        roommatePreference: {
          create: {
            ...
            foodPreference: "No special preference",
            sociabilityLevel: 2,
            notes: "Lower-budget quiet profile for variety within Kandy matches.",
          },
        },
      },
    }),
    prisma.user.create({
      data: {
        username: "demo_student_methmi",
        email: "methmi.demo@boardingfinder.test",
        password: passwordHash,
        fullName: "Methmi Fernando",
        phone: "0783456789",
        gender: "female",
        role: "student",
        isVerified: true,
        roommatePreference: {
          create: {
            ...
            budgetMax: 32000,
            preferredCity: "Colombo",
            preferredArea: "Borella",
            sleepSchedule: "Late sleeper",
            cleanlinessLevel: 3,
            studyHabit: "Flexible",
            smokingAllowed: false,
            petsAllowed: false,
            foodPreference: "Halal-friendly",
            sociabilityLevel: 4,
            notes: "A clearly different city preference for comparison in demos.",
          },
        },
      },
    }),
    prisma.user.create({
      data: {
        username: "demo_student_dinuka",
        email: "dinuka.demo@boardingfinder.test",
        password: passwordHash,
        fullName: "Dinuka Peris",
        phone: "0784567890",
        gender: "male",
        role: "student",
        isVerified: true,
        roommatePreference: {
          create: {
            ...
            foodPreference: "No special preference",
            sociabilityLevel: 3,
            notes: "Included so the same-gender filtering remains obvious in the demo.",
          },
        },
      },
    }),
  ...
  await prisma.bookingRequest.createMany({
    data: [
      ...
      {
        studentId: roommateStudents[0].id,
        ownerId: ownerKandy.id,
        postId: posts[0].id,
        status: "approved",
      },
      {
        studentId: roommateStudents[1].id,
        ownerId: ownerKandy.id,
        postId: posts[0].id,
        status: "pending",
      },
      {
        studentId: roommateStudents[2].id,
        ownerId: ownerKandy.id,
        postId: posts[1].id,
      ...
      {
        studentId: roommateStudents[7].id,
        ownerId: ownerColombo.id,
        postId: posts[2].id,
        status: "confirmed",
      },
